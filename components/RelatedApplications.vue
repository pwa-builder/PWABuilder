...
<section>
  ...
  <div class="l-generator-field">
    <label class="l-generator-label">
      <input type="checkbox" class="l-generator-togglecheck" @change="onChangePreferCheckbox($event)"> {{ $t("related_applications.prefer") }}
    </label>
  </div>
</section>
</template>
...
export default class extends Vue {
  ...
  public onClickAdd(): void {
    try {
      const relatedApplication = { platform: this.platform, url: this.url, id: this.id };
      this.addRelatedApplication(relatedApplication);
