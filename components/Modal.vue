    ...
    <div class="modal-box">
      ...
      <div class="modal-body">
        ...
        <div class="modal-buttons">
          <button class="l-generator-space_right pwa-button pwa-button--simple pwa-button--brand" @click="onClickSubmit();  $awa( { 'uri': 'https://preview.pwabuilder.com/manifest/add-member' });">
            {{$t("modal.submit")}}
            <Loading :active="isLoading" class="u-display-inline_block u-margin-left-sm" />
          </button>
          <button class="pwa-button pwa-button--simple" @click="onClickCancel(); $awa( { 'uri': 'https://preview.pwabuilder.com/manifest/add-member' });">
            {{$t("modal.cancel")}}
          </button>
        </div>
      </div>
