  ...
  render() {
    return html`
      <sl-tab-group id="editor-tabs" @sl-tab-show=${(e: any) => this.setSelectedTab(e)}>
        ...
        <sl-tab-panel name="info" ?active=${this.startingTab === "info"}><manifest-info-form id="info-tab" .focusOn=${this.focusOn} .manifest=${this.manifest} @manifestUpdated=${(e: any) => this.updateManifest(e.detail.field, e.detail.change)} @errorInTab=${(e: CustomEvent) => this.errorInTab(e)}></manifest-info-form></sl-tab-panel>
        <sl-tab-panel name="settings" ?active=${this.startingTab === "settings"}><manifest-settings-form .focusOn=${this.focusOn} .manifest=${this.manifest} @manifestUpdated=${(e: any) => this.updateManifest(e.detail.field, e.detail.change)} @errorInTab=${(e: CustomEvent) => this.errorInTab(e)}></manifest-settings-form></sl-tab-panel>
        <sl-tab-panel name="platform" ?active=${this.startingTab === "platform"}><manifest-platform-form .focusOn=${this.focusOn} id="platform-tab" .manifest=${this.manifest} @manifestUpdated=${(e: any) => this.updateManifest(e.detail.field, e.detail.change)} @errorInTab=${(e: CustomEvent) => this.errorInTab(e)}></manifest-platform-form></sl-tab-panel>
        <sl-tab-panel name="icons" ?active=${this.startingTab === "icons"}><manifest-icons-form .focusOn=${this.focusOn} .manifest=${this.manifest} .manifestURL=${this.cleanUrl(this.manifestURL)} @manifestUpdated=${(e: any) => this.updateManifest(e.detail.field, e.detail.change)} @errorInTab=${(e: CustomEvent) => this.errorInTab(e)}></manifest-icons-form></sl-tab-panel>
        <sl-tab-panel name="screenshots" ?active=${this.startingTab === "screenshots"}><manifest-screenshots-form .focusOn=${this.focusOn} .manifest=${this.manifest} .manifestURL=${this.cleanUrl(this.manifestURL)} .baseURL=${this.cleanUrl(this.baseURL)} @manifestUpdated=${(e: any) => this.updateManifest(e.detail.field, e.detail.change)} @errorInTab=${(e: CustomEvent) => this.errorInTab(e)}></manifest-screenshots-form></sl-tab-panel>
