...
@customElement('app-card-new')
export class AppCardNew extends LitElement {
      ...
      <fast-card class="${classMap({
        ...
        <div class="default-content">
          <div class="image-block">
            <img class="${classMap({
              bordered: this.imageBordered,
            })}" src="${ifDefined(this.imageUrl)}" alt="${this.cardTitle} card header image" role="presentation"/>
          </div>
        ...
        <div class="card-actions">
          <a @click=${this.route} tabindex="0"><span>Learn More</span></a>
        </div>
      </fast-card>
    `;
  }
