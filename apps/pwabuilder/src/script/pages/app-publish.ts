        ...
        ${this.isGooglePlay
          ...
          : html`<android-form
              ...
              @init-android-gen="${(e: CustomEvent) =>
                this.generate(
                  'other-android',
                  e.detail as AndroidPackageOptions
                )}"
            ></android-form>`}
      </app-modal>
