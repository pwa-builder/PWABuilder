...
const grey_enhancement_src = "/assets/new/grey_enhancement.svg";
...
export class AppReport extends LitElement {
  ...
  @state() manifestEnhValid: number = 0;
  @state() manifestEnhCounter: number = 0;
  ...
  async testManifest() {
    ...
    if(!this.createdManifest){
      ...
      let testResults = await runManifestTests(manifest);
      todos.push(...testResults.todos);
      ...
      this.validationResults = testResults.results;
        ...
        <div id="content-holder">
          ...
          html`
            <div class="feedback-holder type-error">
              ...
              <img @click=${() => this.removeSecurityWarning()} class="close_feedback" src="assets/images/Close_desk.png" alt="close icon" />
            </div>
          ` :
          html``}
          ...
          <div id="two-cell-row">
            ...
            <div id="security" class="half-width-cards">
              <div id="sec-header" class="flex-col">
                <div id="sec-top">
                  ...
                  ${this.manifestDataLoading ?
                    ...
                    id="acProgressRing"
                    class="acRing"
                    value="${(this.manifestEnhValid / (this.manifestEnhValid + this.manifestEnhCounter)) * 100}"
                    >${this.manifestEnhValid}</sl-progress-ring>
                    `
                  }
              ...
              <sl-details
                ...
                class="details"
                ?disabled=${this.manifestDataLoading}
                @sl-show=${(e: Event) => this.rotateNinety("ac-details", e)}
                @sl-hide=${(e: Event) => this.rotateZero("ac-details", e)}
                >
                ${this.manifestDataLoading ? 
                  ...
                  html`
                    ...
                    <div class="detail-list">
                      ...
                      html`
                        <div class="test-result" data-field=${result.member}>
                          ${result.valid ?
                            html`<img src=${enhancement_src} alt="passing result icon"/>` :
                            html`
                              <sl-tooltip content=${result.errorString ? result.errorString : ""} placement="right">
                                <img src=${grey_enhancement_src} alt="yield result icon"/>
                              </sl-tooltip>
                            `}
                          <p>${result.displayString}</p>
                        </div>
