      ...
      <div id="congrats-wrapper">
        ...
        <div id="content-holder"> 
          ...
          <div id="next-steps">
            ...
            <ol class="steps-list">
              <li>
                <strong>Create a developer account and reserve your app name:</strong> Use the code above to create a free developer account on <a aria-label="Click here to visit Partner Center Dashboard" href="https://partner.microsoft.com/dashboard" target="_blank" rel="noopener">Partner Center Dashboard</a> and reserve your app on Microsoft store
              </li>
              <li>
