...
export const manifest_fields: { [field: string]: infoPanel} = {
  "name": {
      description:`name is a required member that specifies the display name for your application. Anywhere where a name for this application would be displayed, this value will be used.
  ...
  "short_name": {
      description:`short_name functions similarly as the name member, except that it will only be used when there is not enough character space to display the applications regular name.
  ...
  "description": {
      description:`description is an optional member that can be used to describe the functionality and purpose of your app.
  ...
  "scope": {
      description:`scope is an optional member that defines which URL are within the navigation scope of your application. If the user navigates outside of your app’s scope, the will be navigated to a normal browser window.
  ...
  "display_override": {
      description:`display_override is similar to the display member, but allows you to select a fallback order for different display modes.
  ...
  "related_applications": {
      description:`related_applications is an optional member that specifies applications that have similar or adjacent functionality to your application. This member allows users and store listings to complement your application with related technology.
