  ...
  async firstUpdated() {
    ...
    if (this.userProject && this.userProject.windowsPackageOptions) {
      this.packageOptions = this.userProject
        .iosPackageOptions as IOSAppPackageOptions;
    } else {
      //TODO: Add checkbox if user opts to store their info or not
      this.packageOptions =
        createIOSPackageOptionsFromManifest(manifestContext);
    }
  }
          ...
          <div class="basic-settings">
            <div class="form-group">
              ${super.renderFormInput({
                ...
                tooltipLink:
                  'https://blog.pwabuilder.com/docs/publish-your-pwa-to-the-ios-app-store/#create-your-bundle-id',
                ...
                inputHandler: (val: string) =>
                  (this.packageOptions.bundleId = val),
              })}
            </div>
            ...
            <div class="form-group">
              ${this.renderFormInput({
                ...
                tooltipLink:
                  'https://blog.pwabuilder.com/docs/publish-your-pwa-to-the-ios-app-store',
            ...
            >
                  ...
                  <div class="">
                    <div class="form-group">
                      ${this.renderFormInput({
                        ...
                        required: true,
                        inputHandler: (val: string) =>
                          (this.packageOptions.imageUrl = val),
                      })}
                    </div>
                  </div>
                </div>
              ...
              <div class="form-group">
                ${this.renderFormInput({
                  ...
                  required: true,
                  inputHandler: (val: string) =>
                    (this.packageOptions.statusBarColor = val),
                })}
              </div>
              ...
              <div class="form-group">
                ${this.renderFormInput({
                  ...
                  required: true,
                  inputHandler: (val: string) =>
                    (this.packageOptions.splashColor = val),
                })}
              </div>
              ...
              <div class="form-group">
                ${this.renderFormInput({
                  ...
                  required: true,
                  inputHandler: (val: string) =>
                    (this.packageOptions.progressBarColor = val),
                })}
              </div>
              ...
              <div class="form-group">
                ${this.renderFormInput({
                  ...
                  inputHandler: (val: string) =>
                    (this.packageOptions.permittedUrls = val
                      .split(',')
                      .map(i => i.trim())
                      .filter(i => !!i)),
                })}
        ...
        <div id="form-extras">
          <div id="form-details-block">
            <p>
              ...
              <a
                href="https://blog.pwabuilder.com/docs/build-your-ios-app"
                target="_blank"
                >instructions</a
              >
