...
public class ViteStaticFileProvider : IFileProvider
{
    ...
    public IFileInfo GetFileInfo(string subpath)
    {
        ...
        {
            var frontendFile = new FileInfo(
                Path.Combine(contentRootPath, "Frontend", subpath.TrimStart('/'))
            );
            ...
            else
            {
                ...
                var publicFile = new FileInfo(
                    Path.Combine(contentRootPath, "Frontend", "public", subpath.TrimStart('/'))
                );
