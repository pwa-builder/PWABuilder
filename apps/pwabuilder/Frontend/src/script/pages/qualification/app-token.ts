      ...
      return html`
        <div id="over-wrapper">
          <div id="over-main-content">
            ...
            <p class="over-socials-prompt">Please check our X account
              <a href="https://x.com/pwabuilder" rel="noopener" target="_blank" @click=${() => this.trackLinkClick("campaign_over_twitter")}>@PWABuilder</a>
              or join our
            ...
            <div id="icons-section">
              <a href="https://x.com/pwabuilder" rel="noopener" target="_blank" @click=${() => this.trackLinkClick("campaign_over_twitter_icon")}>
                <img class="twt" src='/assets/twitter-x.svg' alt="x logo" />
              </a>
              <a href="https://aka.ms/pwabuilderdiscord" rel="noopener" target="_blank" @click=${() => this.trackLinkClick("campaign_over_discord_icon")}>
                <img class="disc" src='/assets/discord.svg' alt="discord logo">
              </a>
            </div>
          </div>
        </div>
