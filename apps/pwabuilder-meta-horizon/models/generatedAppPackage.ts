...
/**
 * The output of this tool: an APK file for testing locally on a device or Quest emulator.
...
export interface GeneratedAppPackage {
    /**
     * The path to the .aab app bundle file. This is the file that is submitted to the Meta Horizon Store. This will be null when no signing key is supplied.
     */
    appBundleFilePath: string | null;
    /**
     * The path to the .apk file. This file is used for testing your app on a Meta Quest device or emulator.
     */
    apkFilePath: string;
    /**
