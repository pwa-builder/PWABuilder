import { MetaHorizonPackageJob } from "./metaHorizonPackageJob.js";
import { PackageCreationProgress } from "./packageCreationProgress.js";

/**
 * A logger that writes logs to a Meta Horizon packaging job's log storage.
 */
export class PackageJobLogger {
    /**
     * Creates a new logger for the specified app package job.
     */
    constructor(private readonly job: MetaHorizonPackageJob) {
    }
