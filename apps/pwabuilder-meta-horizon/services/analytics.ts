...
export function setupAnalytics() {
    try {
        ...
        if (connectionString) {
            ...
            tracer = trace.getTracer('pwabuilder-meta-horizon', '1.0.0');
            meter = metrics.getMeter('pwabuilder-meta-horizon', '1.0.0');
...
export function trackEvent(
    ...
    try {
        const eventName = success ? 'MetaHorizonPackageEvent' : 'MetaHorizonPackageFailureEvent';
