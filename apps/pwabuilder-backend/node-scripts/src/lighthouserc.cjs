const settings = require('./custom-settings.cjs');
...
module.exports = {
  ...
  artifacts: [
    ...
    { id: "InspectorIssues", gatherer: "inspector-issues" },
    {
      ...
      gatherer:
        "node-scripts/dist/src/custom-audits/service-worker/service-worker-gatherer",
    },
    { id: "WebAppManifest", gatherer: "web-app-manifest" },
    {
      id: "OfflineGatherer",
      gatherer: "node-scripts/dist/src/custom-audits/offline/offline-gatherer",
    },
  ...
  audits: [
    "is-on-https",
    "node-scripts/dist/src/custom-audits/service-worker/service-worker-audit",
    "node-scripts/dist/src/custom-audits/offline/offline-audit",
    "node-scripts/dist/src/custom-audits/https/https-audit",
    "viewport",
