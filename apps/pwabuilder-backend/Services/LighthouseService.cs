...
namespace PWABuilder.Services
{
    public class LighthouseService : ILighthouseService
    {
        ...
        {
            string nodeSrcDirectory = "node-scripts\\src";
            ...
            var lighthouseSettingsFileUrl = new Uri(lighthouseSettingsPath).AbsoluteUri;
            ...
            var customSettingsFileUrl = new Uri(customSettingsPath).AbsoluteUri;

            var configContent =
                $@"
import lighthouseSettings from '{lighthouseSettingsFileUrl}';
import customSettings from '{customSettingsFileUrl}';
customSettings.screenEmulation = {screenEmulation};
customSettings.emulatedUserAgent = '{userAgent}';
...
export default {{
  ...
  settings: {{
    ...customSettings,
    screenEmulation: customSettings.screenEmulation,
    emulatedUserAgent: customSettings.emulatedUserAgent
  }}
}};
";
