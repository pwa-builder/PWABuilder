      ...
      <div class="pure-g">
        ...
        <div class="pure-u-1 pure-u-md-1-2">
          <div class="pwa-infobox-box pwa-infobox-box--flat">
            ...
            <p>
              <button class="pwa-button pwa-button--simple pwa-button--brand" @click="openAppXModal();  $awa( { 'uri': 'https://preview.pwabuilder.com/publish/windows10-appx' })"> {{ $t('publish.generate_appx') }}</button>
            </p>
          </div>
        </div>
