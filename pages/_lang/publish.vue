        ...
        <div id="introContainer">
          ...
          <div id="devicePreviews">
            <div id="mobileDevicePreview" v-if="iphoneDevice">
              <img src="~/assets/images/platformScreens/ios.png" alt="iphone device preview">
            </div>
            <div id="mobileDevicePreview" v-else-if="androidDevice">
              <img src="~/assets/images/platformScreens/samsung.png" alt="android device preview">
            </div>
            <div id="mobileDevicePreview" v-else-if="samsungDevice">
              <img src="~/assets/images/platformScreens/samsung.png" alt="android device preview">
            </div>
            <div id="desktopDevicePreview" v-else-if="pcDevice">
              <img src="~/assets/images/platformScreens/pc.png" alt="pc device preview">
            </div>
            <div id="teamsDevicePreview" v-else-if="teamsDevice">
              <img src="~/assets/images/platformScreens/teams.png" alt="teams device preview">
            </div>
            <div id="macDevicePreview" v-else-if="macDevice">
              <img src="~/assets/images/platformScreens/mac.png" alt="mac device preview">
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="publishRightSide">
        <div id="platformsListContainer">
          <ul>
            ...
            <div
              @mouseover="platCardHover($event, 'teams')"
              @mouseleave="platCardUnHover($event, 'teams')"
              id="pwaTeamsCard"
              class="pwaCard"
            >
              <div class="pwaCardHeaderBlock">
