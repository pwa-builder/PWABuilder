            ...
            <div class="pwa-generator-padded pure-g">
                <div class="pwa-generator-form pure-u-1 pure-u-md-1-2">
                    ...
                    <div class="pwa-generator-field">
                        ...
                        <input id="fileName" name="fileName" class="l-hidden" type="file" ref="fileName"
                        @change="changeLabel">
                    </div>
...
export default {
    ...
    methods: {
        useAPI() {
            ...
            //const urlUseAPI = "https://appimagegenerator-prod.azurewebsites.net/api/image";
            const urlUseAPI = 'http://localhost:49080/';
            ...
            .then(result => {
                    ...
                    const win = window.open(urlUseAPI + fileUri.substring(1),"_blank");
