  ...
  <div>
    ...
    <main id="main" role="presentation">
      <div class="pwa-generator">
        <p
          class="pwa-generator-info"
        >Quickly and easily create app icons for various platforms in the right size and format</p>
          ...
          <form id="imageFileInputForm" enctype="multipart/form-data" role="form" ref="form">
            <div class="pwa-generator-padded pure-g">
              <div class="pwa-generator-form pure-u-1 pure-u-md-1-2">
                <h4 class="pwa-generator-subtitle">Image Details</h4>
                <h4
                  class="pwa-generator-subtitle pwa-generator-subtitle--last"
                >Specify the image details below.</h4>
                <div class="pwa-generator-field">
                  <span class="pwa-generator-label">Input Image</span>
                  <label
                    class="pwa-generator-input pwa-generator-input--fake is-disabled"
                    id="fileNameLabel"
                    for="fileName"
                    ref="fileNameLabel"
                  >{{labelFileName}}</label>
                ...
                <div class="pwa-generator-field">
                  ...
                  <input
                    class="pwa-generator-input pwa-generator-input--hassmall"
                    name="padding"
                    type="number"
                    value="0.3"
                    min="0"
                  ...
                  />
                  <small
                    class="pwa-generator-small"
                  >0 is no padding, 1 is 100% of the source image. 0.3 is a typical value for most icons</small>
                </div>
                <div class="pwa-generator-field">
                  ...
                  <div class="pwa-generator-options">
                    ...
                    <div class="colorpickers">
                      <input
                        class="pwa-generator-input pwa-generator-input--tiny input-color"
                        type="color"
                      />
                      <input
                        class="pwa-generator-input pwa-generator-input--small pwa-generator-input--hassmall"
                        placeholder="#000000"
                        name="color"
                        id="color"
                        type="text"
                      ...
                      <small
                        class="pwa-generator-small"
                      >Choose a color for the background (leave blank to default to the pixel at the top left)</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="pwa-generator-form pure-u-1 pure-u-md-1-2">
                <h4 class="pwa-generator-subtitle">Platforms</h4>
