        ...
        <div class="pure-u-1 pure-u-md-3-5 pure-u-lg-2-5">
          ...
          <div class="l-generator-form">
            <div class="l-generator-field">
              ...
              <input class="l-generator-input" placeholder="Enter a URL" name="siteUrl" type="url">
            </div>

            <div class="pure-g l-breath">
              <div class="l-generator-wrapper pure-u-3-5">
                  <button data-flare="{'category': 'Build', 'action': 'Step 2', 'label': 'Scan for Manifest', 'value': { 'page': '/build/manifest-scan' }}" class="get-started pwa-button isEnabled next-step">
                          Get Started
                  </button>
              </div>
