...
In this example, we've added a few extra fields to our shorcut. `short_name` provides an alternate name to display for your shortcut if there is limited display space, while `icons` allows you to specify a custom icon to display for your shorcut in the context menu.
