...
export const allPosts: Array<BlogPost> = [
  ...
  },
  {
    ...
    shareUrl: 'https://blog.pwabuilder.com/posts/microsoft-and-google-team-up-to-make-pwas-better-in-the-play-store/',
    clickUrl: 'https://blog.pwabuilder.com/posts/microsoft-and-google-team-up-to-make-pwas-better-in-the-play-store/',
    tags: ['Android', 'Store'],
  ...
  },
  {
    ...
    shareUrl: 'https://blog.pwabuilder.com/posts/building-pwas-with-web-components!/',
    clickUrl: 'https://blog.pwabuilder.com/posts/building-pwas-with-web-components!/',
