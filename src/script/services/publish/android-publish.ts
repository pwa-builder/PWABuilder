...
export async function createAndroidPackageOptionsFromForm(form: HTMLFormElement): Promise<AndroidApkOptions> {
  ...
  return {
    ...
    signing: {
      ...
      countryCode: form.countryCode.value || 'US',
      keyPassword: form.keyPassword.value || '', // If empty, one will be generated by CloudAPK service
      storePassword: form.storePassword.value || '', 
    },
