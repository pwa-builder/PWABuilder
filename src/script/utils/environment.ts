...
if ((window as any).ENV == 'production') {
  ...
  env.windowsPackageGeneratorUrl =
    'https://pwabuilder-winserver-chromium-platform.centralus.cloudapp.azure.com/msix/generatezip';
  ...
  env.oculusPackageGeneratorUrl =
    'https://pwabuilder-oculus.centralus.cloudapp.azure.com/packages/create';
