...
export function lazyLoadAnalytics(): Promise<AppInsights> {
...
export function tryInitAnalytics(): Error | AppInsights {
  try {
...
export interface PageViewTelemetry {
  uri: string;
  name?: string;
  properties?: unknown;
}

export interface PageActionTelemetry {
  /**
     * Page name.
     */
  name?: string;
...
export interface IPageActionOverrideValues {
